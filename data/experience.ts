...
export const experienceData: ExperienceItem[] = [
    {
        ...
        details: [
            "Engineered responsive user interfaces and robust backend service features for web applications.",
            "Optimized frontend performance metrics and state management across full-stack component workflows.",
